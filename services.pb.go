...
var file_playground_environments_services_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xfe, 0x05, 0x0a, 0x0c, 0x45, 0x6e,
	...
	0x2f, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x3a, 0x01, 0x2a, 0x42, 0x55, 0x5a, 0x53, 0x67, 0x69,
...
var file_playground_environments_services_proto_goTypes = []interface{}{
	...
	(*EnvironmentInfoResponse)(nil),                 // 6: playground_environments.EnvironmentInfoResponse
	(*grpc_playground_common_go.TokenResponse)(nil), // 7: playground_common.TokenResponse
	(*Environment)(nil),                             // 8: playground_environments.Environment
...
var file_playground_environments_services_proto_depIdxs = []int32{
	...
	6, // 8: playground_environments.Environments.Info:output_type -> playground_environments.EnvironmentInfoResponse
	7, // 9: playground_environments.Environments.Use:output_type -> playground_common.TokenResponse
	8, // 10: playground_environments.Environments.Create:output_type -> playground_environments.Environment
	9, // 11: playground_environments.Environments.Delete:output_type -> playground_common.OpResponse
